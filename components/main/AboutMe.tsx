...
const AboutMe = () => {
  return (
    <section
      id="about-me"
      className="flex flex-col lg:flex-row items-center justify-center gap-3 max-w-screen-xl h-auto relative lg:w-5/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none px-5 bg-transparent mx-auto z-[20]"
    >
      ...
      <div className="w-full lg:w-4/5 p-4 md:p-12 text-center lg:text-left">
        ...
        <p className="pt-8 text-sm gap-2  text-white">
          ...
          Polytechnic Institute of Viana do Castelo. My path began with a CTeSP
          in Computer Systems Programming Technician, a course that gave me some
          foundations and served as a springboard for my remaining academic
          career.
          <br></br>
          <br></br>I&apos;m a person who likes to embrace challenges and absorb
          new knowledge. I consider myself to be a flexible, communicative and
          resilient person who enjoys working as part of a team, always looking
          for new challenges and opportunities that will allow me to grow.
          <br></br>
